...
function OrderItemList({ orderId, orderDetails, loadingDetails, onBookClick }) {
    ...
    return (
        <div
            ...
            style={{
                maxHeight: orderDetails.items.length * 250 + 100,
                opacity: 1,
            ...
            <div className="space-y-6">
                {orderDetails.items.map((item) => (
                    <div
                        ...
                        className="flex gap-4 pb-4 border-b last:border-b-0 cursor-pointer hover:bg-gray-50 transition p-2 rounded-md"
